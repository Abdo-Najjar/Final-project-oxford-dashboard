...
Route::group([
    ...
    Route::crud('massmedia', 'MassMediaCrudController');
    Route::crud('sectionevaluation', 'SectionEvaluationCrudController');
    Route::crud('teacherevaluation', 'TeacherEvaluationCrudController');
